const Senin = () => {
  return (
    <>
      ...
      >
        <div className="w-[50%] text-base  font-medium">Upacara & Pramuka</div>
      ...
      >
        <div className="w-[50%] text-base  font-medium">CB</div>
        <div className="flex justify-center items-center text-sm">
          09.15-10.15
        </div>
      </div>
      ...
      >
        <div className="w-[50%] text-base  font-medium">Physic</div>
        <div className="flex justify-center items-center text-sm">
          10.15-11.15
        </div>
      </div>
